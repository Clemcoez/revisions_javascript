class MonumentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @monument.save
        format.html { redirect_to monument_url(@monument), notice: "Monument was successfully created." }
  ...
  def update
    respond_to do |format|
      if @monument.update(monument_params)
        format.html { redirect_to monument_url(@monument), notice: "Monument was successfully updated." }
